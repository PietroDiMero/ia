...
Ci‑dessous, toutes les commandes PowerShell pour Windows en supposant une installation sur `D:\self_improving_assistant`.
...
New-Item -ItemType Directory -Path 'D:\self_improving_assistant' -Force | Out-Null
Set-Location 'D:\self_improving_assistant'
...
```powershell
# Depuis D:\self_improving_assistant (venv activé)
...
```powershell
# Depuis D:\self_improving_assistant
.\run_eval.bat
.\run_abtest.bat
.\run_promote.bat
```
